...
Key changes to be made in each block are: vsc_id and, potentially (especially for windows users) the location of your `id_rsa` file.
...
## Convenient command aliases and bashrc export variables
